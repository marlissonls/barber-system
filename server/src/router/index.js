...
router.get('/agendamento/barbeiro/:userId', auth.required, agendamentoController.barbeiroAgendamentos)
router.get('/agendamento/gerente/:cadeiraId/:data', auth.required, agendamentoController.cadeiraAgendamentos)
